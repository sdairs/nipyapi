...
class FDProcessGroupFlow(object):
    """
    ...
    swagger_types = {
        ...
        'flow_content': 'FDProcessGroupFlowContent',
    ...
    def __init__(self, flow_metadata=None, flow_content=None, version_info=None, local_flow_revision=None):
        """
        FDProcessGroupFlow - a model defined in Swagger
        """
    ...
    def flow_metadata(self):
        """
        Gets the flow_metadata of this FDProcessGroupFlow.
        The flow metadata

        :return: The flow_metadata of this FDProcessGroupFlow.
    ...
    def flow_metadata(self, flow_metadata):
        """
        Sets the flow_metadata of this FDProcessGroupFlow.
        The flow metadata

        :param flow_metadata: The flow_metadata of this FDProcessGroupFlow.
        :type: FDFlowMetadata
        """
    ...
    def flow_content(self):
        """
        Gets the flow_content of this FDProcessGroupFlow.
        The flow content of the process group

        :return: The flow_content of this FDProcessGroupFlow.
        :rtype: FDProcessGroupFlowContent
        """
    ...
    def flow_content(self, flow_content):
        """
        Sets the flow_content of this FDProcessGroupFlow.
        The flow content of the process group

        :param flow_content: The flow_content of this FDProcessGroupFlow.
        :type: FDProcessGroupFlowContent
        """
    ...
    def version_info(self):
        """
        Gets the version_info of this FDProcessGroupFlow.
        The version information for the flow

        :return: The version_info of this FDProcessGroupFlow.
        :rtype: FDVersionInfo
        """
    ...
    def version_info(self, version_info):
        """
        Sets the version_info of this FDProcessGroupFlow.
        The version information for the flow

        :param version_info: The version_info of this FDProcessGroupFlow.
        :type: FDVersionInfo
        """
    ...
    def local_flow_revision(self):
        """
        Gets the local_flow_revision of this FDProcessGroupFlow.
        The local revision number for the given flow used to order flow events per flow

        :return: The local_flow_revision of this FDProcessGroupFlow.
        :rtype: int
        """
    ...
    def local_flow_revision(self, local_flow_revision):
        """
        Sets the local_flow_revision of this FDProcessGroupFlow.
        The local revision number for the given flow used to order flow events per flow

        :param local_flow_revision: The local_flow_revision of this FDProcessGroupFlow.
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, FDProcessGroupFlow):
            return False
