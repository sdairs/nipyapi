...
class FDControllerService(object):
    """
    ...
    swagger_types = {
        'uri': 'str',
        'revision': 'FDRevision',
        'component_configuration': 'VersionedControllerService',
        'validation_errors': 'list[str]',
        'component_definition': 'ControllerServiceDefinition'
    }
    ...
    def __init__(self, uri=None, revision=None, component_configuration=None, validation_errors=None, component_definition=None):
        """
        FDControllerService - a model defined in Swagger
        """
    ...
    def uri(self):
        """
        Gets the uri of this FDControllerService.
        The URI for future requests to the component.

        :return: The uri of this FDControllerService.
        :rtype: str
        """
        return self._uri
    ...
    def uri(self, uri):
        """
        Sets the uri of this FDControllerService.
        The URI for future requests to the component.

        :param uri: The uri of this FDControllerService.
        :type: str
        """
    ...
    def revision(self):
        """
        Gets the revision of this FDControllerService.
        The revision for this request/response. The revision is required for any mutable flow requests and is included in all responses.

        :return: The revision of this FDControllerService.
        :rtype: FDRevision
        """
    ...
    def revision(self, revision):
        """
        Sets the revision of this FDControllerService.
        The revision for this request/response. The revision is required for any mutable flow requests and is included in all responses.

        :param revision: The revision of this FDControllerService.
        :type: FDRevision
        """
    ...
    def component_configuration(self):
        """
        Gets the component_configuration of this FDControllerService.
        The configuration of the component.

        :return: The component_configuration of this FDControllerService.
        :rtype: VersionedControllerService
        """
    ...
    def component_configuration(self, component_configuration):
        """
        Sets the component_configuration of this FDControllerService.
        The configuration of the component.

        :param component_configuration: The component_configuration of this FDControllerService.
    ...
    def validation_errors(self):
        """
        Gets the validation_errors of this FDControllerService.
        ...
        :return: The validation_errors of this FDControllerService.
        :rtype: list[str]
        """
    ...
    def validation_errors(self, validation_errors):
        """
        Sets the validation_errors of this FDControllerService.
        Zero or more reasons that the component is currently invalid as-configured. The component is said to be valid if the returned Collection is empty.

        :param validation_errors: The validation_errors of this FDControllerService.
        :type: list[str]
        """
    ...
    def component_definition(self):
        """
        Gets the component_definition of this FDControllerService.
        ...
        :return: The component_definition of this FDControllerService.
    ...
    def component_definition(self, component_definition):
        """
        Sets the component_definition of this FDControllerService.
        The definition of the component including available properties, allowable values, allowed scheduling strategies, input requirements, etc.

        :param component_definition: The component_definition of this FDControllerService.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, FDControllerService):
            return False
