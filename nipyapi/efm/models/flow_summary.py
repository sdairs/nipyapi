...
class FlowSummary(object):
    ...
    def __init__(self, id=None, registry_url=None, registry_bucket_id=None, registry_flow_id=None, registry_flow_version=None, flow_format=None, created=None, updated=None, uri=None):
        """
    ...
    def id(self):
        """
        Gets the id of this FlowSummary.
        A unique identifier of the flow

        :return: The id of this FlowSummary.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this FlowSummary.
        A unique identifier of the flow

        :param id: The id of this FlowSummary.
        :type: str
        """
        if id is None:
    ...
    def registry_url(self, registry_url):
        """
        Sets the registry_url of this FlowSummary.
        The URL of the NiFi Registry this flow was retrieved from, or null if the flow came from direct upload

        :param registry_url: The registry_url of this FlowSummary.
        :type: str
        """
    ...
    def registry_bucket_id(self, registry_bucket_id):
        """
        Sets the registry_bucket_id of this FlowSummary.
        The id of the NiFi Registry bucket this flow was retrieved from, or null if the flow came from direct upload

        :param registry_bucket_id: The registry_bucket_id of this FlowSummary.
        :type: str
        """
    ...
    def registry_flow_id(self, registry_flow_id):
        """
        Sets the registry_flow_id of this FlowSummary.
        The id of the NiFi Registry flow this flow was retrieved from, or null if the flow came from direct upload

        :param registry_flow_id: The registry_flow_id of this FlowSummary.
        :type: str
        """
    ...
    def registry_flow_version(self, registry_flow_version):
        """
        Sets the registry_flow_version of this FlowSummary.
        The version of the NiFi Registry flow this flow was retrieved from, or null if the flow came from direct upload

        :param registry_flow_version: The registry_flow_version of this FlowSummary.
        :type: int
        """
    ...
    def flow_format(self, flow_format):
        """
        Sets the flow_format of this FlowSummary.
        The format of the flow indicating how the content should be interpreted when retrieving the flow content

        :param flow_format: The flow_format of this FlowSummary.
        :type: str
        """
    ...
    def created(self):
        """
        Gets the created of this FlowSummary.
        The date this flow was created in the C2 server

        :return: The created of this FlowSummary.
        :rtype: datetime
        """
    ...
    def created(self, created):
        """
        Sets the created of this FlowSummary.
        The date this flow was created in the C2 server

        :param created: The created of this FlowSummary.
        :type: datetime
        """
    ...
    def updated(self):
        """
        Gets the updated of this FlowSummary.
        The date this flow was updated in the C2 server

        :return: The updated of this FlowSummary.
        :rtype: datetime
        """
    ...
    def updated(self, updated):
        """
        Sets the updated of this FlowSummary.
        The date this flow was updated in the C2 server

        :param updated: The updated of this FlowSummary.
        :type: datetime
        """
    ...
    def uri(self):
        """
        Gets the uri of this FlowSummary.
        The URI to retrieve this flow

        :return: The uri of this FlowSummary.
        :rtype: str
        """
        return self._uri
    ...
    def uri(self, uri):
        """
        Sets the uri of this FlowSummary.
        The URI to retrieve this flow

        :param uri: The uri of this FlowSummary.
        :type: str
        """
